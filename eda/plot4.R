...
with(datacopy, {
  plot(datacopy$Time, datacopy$Global_active_power, type = "s", xlab = "", ylab = "Global Active Power")
  
  plot(datacopy$Time, datacopy$Voltage, type = "s", xlab = "datetime",ylab = "Voltage")
...
plot(datacopy$Time, datacopy$Global_reactive_power, type = "s", xlab = "datetime", ylab = "Global_reactive_power")
